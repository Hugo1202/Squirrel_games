...
public class Prueba {
     ...
     * @param inscritos, es una lista de los participantes que hay antes de iniciar la prueba.
     * @param eliminados, es la lista de los participantes que han sido eliminados en la prueba.
     * @param vencedores, es la lista de los participantes que han superado la prueba.
     */
	 ...
	 * 
	 * Este método toma una lista de participantes y simula una prueba, donde seran eliminados de manera aleatoria. 
	 * 
	 * El flujo es:
	 * <ol>
	 *   <li>Se registran los participantes como "inscritos".</li>
	 *   <li>Se calcula el porcentaje de eliminados de forma aleatoria, dentro de un rango permitido.</li>
	 *   <li>Se mezclan los inscritos (shuffle) para que la eliminación sea aleatoria.</li>
	 *   <li>Se eliminan los participantes correspondientes al porcentaje de eliminados </li>
