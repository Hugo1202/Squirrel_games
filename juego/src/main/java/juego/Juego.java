 ...
 * 
 * <p>La clase juego es la que se encarga de unir todas las demas clases para realizar
 * la simulación del juego.</p>
 * 
 * 
 * @version 1.0
 * @see Prueba.java
...
//	private List<Pink_guards> guardias;
	 ...
	 * 
	 * En cada ronda, se simula una prueba utilizando la lista de participantes vivos.
	 * Además, por cada participante eliminado en la prueba, se suman 10.000 € 
	 * al bote total.
	 * 
	 * El flujo es:
	 * <ol>
	 *   <li>Se comprueba si quedan pruebas por jugar, comparando <code>pruebaActual</code> con el tamaño de la lista de pruebas.</li>
	 *   <li>Si hay pruebas pendientes, se ejecuta la prueba actual llamando a <code>simularPrueba()</code>, pasándole la lista de participantes vivos.</li>
	 *   <li>Se calcula el dinero que se añade al bote: 10.000 por cada eliminado en la prueba.</li>
	 *   <li>Se incrementa el contador <code>pruebaActual</code> para avanzar a la siguiente ronda.</li>
	 * </ol>
	 ...
	 * 
	 * Este método recorre la lista de participantes y muestra la información de cada uno.
	 * El flujo es:
	 * <ol>
	 *   <li>Se crea un String vacío llamado 'info'.</li>
	 *   <li>Se recorre la lista completa de participantes usando un bucle for.</li>
	 *   <li>En cada iteración, se añade la información del participante al String 'info'.</li>
	 *   <li>Cada participante se añade seguido de un salto de línea.</li>
	 *   <li>Al finalizar el bucle, se devuelve el String completo con la información de todos los participantes.</li>
	 * </ol>
	 * 
	...
	/**
	 * Devuelve la información de los participantes que siguen vivos (no eliminados).
	 * 
	 * Este método recorre la lista de participantes y verifica si el participante no haya sido eliminado.
	 * 
	 * El flujo es:
	 * <ol>
	 *   <li>Se crea un String llamado 'vivos' con el texto inicial "Participantes sobrevivientes:".</li>
	 *   <li>Se recorre la lista completa de participantes usando un bucle for-each.</li>
	 *   <li>En cada iteración, se comprueba si el participante no está eliminado con <code>isEliminado()</code> de la clase {@code Participantes}.</li>
	 *   <li>Si no está eliminado, se añade su información  al String 'vivos'.</li>
	 *   <li>Al finalizar el bucle, se devuelve el String completo con la información de todos los participantes vivos.</li>
	 * </ol>
	 * 
	 ...
	 * 
	 * Este método recorre la lista de participantes y verifica si han sido eliminados.
	 * 
	 * El flujo es:
	 * <ol>
	 *   <li>Se crea un String llamado 'muertos' con el texto inicial "Participantes eliminados:".</li>
	 *   <li>Se recorre la lista completa de participantes usando un bucle for-each.</li>
	 *   <li>En cada iteración, se comprueba si el participante está eliminado con <code>isEliminado()</code> de la clase {@code Participantes}.</li>
	 *   <li>Si está eliminado, se añade su información al String 'muertos'.</li>
	 *   <li>Al finalizar el bucle, se devuelve el String completo con la información de todos los eliminados.</li>
	 * </ol>
	 * 
     ...
     * 
     * Este método recorre la lista de participantes y filtra aquellos que no han sido eliminados,
     * 
     * El flujo es:
     * <ol>
     ...
     *   <li>Al finalizar el bucle, se devuelve la lista 'vivos', que contiene solo los participantes que no han sido eliminados.</li>
     * </ol>
     * 
     ...
     * El flujo es:
     * <ol>
     *   <li>Se inicializa un String llamado 'info' con el encabezado "Participantes infiltrados:".</li>
     *   <li>Se recorre la lista de participantes usando un bucle for.</li>
     *   <li>En cada iteración, se verifica si el participante es infiltrado llamando a <code>isInfiltrado()</code> de la clase {@code Participantes}</li>
     *   <li>Si es infiltrado, se añade al String 'info', seguido de un salto de línea.</li>
     *   <li>Al finalizar el bucle, se devuelve el String completo con los infiltrados encontrados.</li>
     * </ol>
     * 
	 ...
	 * 
	 * Este método recorre la lista de pruebas de la clase y devuelve cada prueba y su descripción.
	 * 
	 * El flujo es:
	 * <ol>
	 ...
	 *   <li>Se concatena esta información a la cadena 'info', seguido de un salto de línea.</li>
	 *   <li>Al finalizar el bucle, se devuelve el String completo con la información de todas las pruebas.</li>
	 * </ol>
	 * 
